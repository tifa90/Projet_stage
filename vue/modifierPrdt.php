<?php
  require_once '../controller/modifierP.php';
?>  
...
<head>
  ...
  <script type="text/javascript">
      ...
      //Compter le nombre de mot lorsqu'on rentre le titre du produit
...
//Compter le nombre de mot lorsqu'on rentre la description du produit
      function compte(val) {
        var len = val.value.length;
        max = 70;
        if (len >= max) {
...
<!--colonne pour le menu vertical-->
          ...
          <div class="col-2 offset-2">
            ...
            <div class="d-block mx-auto p-1 mt-4 position-relative form2">
            ...
            <div class="d-block  mx-auto p-1 mt-4 position-relative form">
              <h3 class="titre  p-1 mt-2 ">Modification</h3>

              <form action="confirmationPrdt.php?id_confirm=<?php echo $_REQUEST['id_update']; ?>" method="post" enctype="multipart/form-data" role ="form" class="form-horizontal" data-toggle="validator" novalidate="true">

                <div class="d-block offset-2 p-2 mt-0 bg-dark text-white position-relative gene">Informations générales</div>
              ...
              <!-- formulaire 1-->
                    ...
                    <div class="mb-3">
                      <input type="file" name="fichier" value="<?php  echo $visuel; ?> "  data-error="Charger une image"  required/> <br />
                      <div class="help-block with-errors"></div> 
                    </div>
...
<!-- bouton sommettre -->
                <div class="form-group position-relative mb-0">
                  <div class="btn-holder">
                    <button type="submit" name= "btn_update" class="btn btn-info d-block mx-auto p-1 mt-5">Modification</button>
                  </div>
                </div>
              <div>
            </div>
